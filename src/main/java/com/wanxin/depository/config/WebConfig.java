...
import com.wanxin.depository.interceptor.LocalRequestInterceptor;
import com.wanxin.depository.interceptor.P2PRequestInterceptor;
import com.wanxin.depository.interceptor.VerificationInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(p2PRequestInterceptor).addPathPatterns("/gateway/**").addPathPatterns("/service/**");
    }
